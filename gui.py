...
class GolGUI:
    def __init__(self, gol: GOL):
        ...
        self.step_button.grid(row=2, column=1, padx=5, pady=5)
        ...
        self.info_Label.grid(row=3, column=0, padx=5, pady=5)
